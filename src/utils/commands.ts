...
Available commands: apply, help, theme, manifesto, socials, operator`;
...
`;
  ...
  socials: () => {
    ...
    <br/><br/><a class="link" href="https://discord.gg/logosnetwork" target="_blank">https://discord.gg/logosnetwork</a>
</template>
`;
  },
  banner: () => {
